      ...
      <div class="row">
        <div class="col-12">
          ...
          <div class="row mb-3">
            ...
            <div class="col-12 col-sm-5">
              <a-input-password  placeholder="New Password" v-model:value="password"/>
              <div class="w-100"></div>
...
export default defineComponent({
  setup(){
    ...
    const getUsersEdit=()=>{
      axios.get(`http://127.0.0.1:8000/api/data/${route.params.id}/users-edit`)
          .then((response)=>{
    ...
    const updateUsers=()=>{
      axios.put(`http://127.0.0.1:8000/api/data/${route.params.id}/users`, user)
          .then((response)=>{
            if(response){
